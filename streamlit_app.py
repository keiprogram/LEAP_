...
# アプリの設定
st.set_page_config(page_title="LEAP Basic英単語テスト", page_icon='English Logo.png')
...
ranges = [(i + 1, i + 100) for i in range(0, 1400, 100)]
...
st.sidebar.markdown(
    ...
    <div style="text-align: center; margin-top: 20px;">
        <p>こちらのアプリもお試しください</p>
        <a href="https://greenleap.streamlit.app/" target="_blank" 
